...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-dashboard">
      <header className="border-b border-gray-300 dark:border-gray-800/60 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link href="/dashboard-publik">
              <Button variant="ghost" className="text-gray-700 dark:text-gray-300">Dashboard Publik</Button>
            </Link>
            <Link href="/login">
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={item.title}
                className="p-6 bg-white dark:bg-gray-900/80 rounded-xl border border-gray-300 dark:border-gray-800/60 hover:border-purple-300 dark:hover:border-purple-700 transition-all duration-200 hover:shadow-md hover:shadow-purple-900/5 group"
              >
      ...
      <footer className="border-t border-gray-300 dark:border-gray-800/60 bg-white/50 dark:bg-gray-950/50 py-8">
